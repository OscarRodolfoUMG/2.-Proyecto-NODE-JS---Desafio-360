...
export const createCliente = async (req, res) => {
    const { nombre_comercial, razon_social, direccion_entrega, telefono, fk_id_usuario } = req.body;
    try {
...
export const updateCliente = async (req, res) => {
    const { id } = req.params;
    const { nombre_comercial, razon_social, direccion, telefono, fk_id_usuario } = req.body;
    try {
        await sequelize.query(
